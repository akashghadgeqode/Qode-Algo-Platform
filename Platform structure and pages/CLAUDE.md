...
| Analytics | `Analytics.dc.html` | Sidebar-shell app page, titled "Current Analysis", reached via the sidebar menu (Current Analysis/Positions/Orders/Holdings); date-range filter (1M/3M/6M/1Y/Custom), P&L-over-time chart, P&L by algo and by broker, daily P&L table |
